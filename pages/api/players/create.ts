...
const handler = async (
  ...
  try {
    ...
    const playerProfile = await prisma.player.create({
      data: {
        user: { connect: { id: player.id } },
        bio: player.bio,
        academicEngagementScore: player.academicEngagementScore,
        academicEngagementComments: player.academicEngagementComments,
        advisingScore: player.advisingScore,
        advisingComments: player.advisingComments,
        gpa: player.gpa,
        disciplinaryActions: player.disciplinaryActions,
        schoolAbsences: player.schoolAbsences,
        advisingAbsences: player.advisingAbsences,
        bmi: player.bmi,
        healthAndWellness: player.healthAndWellness,
        beepTest: player.beepTest,
